...
public class SalaModel {
	...
	public List<Sala> listaPorFechaCreacion(Date fecIni, Date fecFin) {
		ArrayList<Sala> salida = new ArrayList<Sala>();
		Connection con = null;
		PreparedStatement pstm = null;
		ResultSet rs = null; // Trae la data de la BD
		try {
			con = MySqlDBConexion.getConexion();
			String sql = "SELECT sa.*, se.nombre FROM sala sa inner join sede se on sa.idSede = se.idSede where sa.fechaRegistro between ? and ?";
			pstm = con.prepareCall(sql);
